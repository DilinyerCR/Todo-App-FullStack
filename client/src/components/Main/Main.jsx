  ...
  return (
    <div className="px-25">
        ...
        <div className="mt-[-90px]">
            <div>
                <form className='pl-20 pr-15 h-48 bg-very-light-gray rounded-6 flex items-center text-13 dark:bg-very-dark-desaturated-blue'>
                    ...
                    <input className='pl-5 w-[88%] h-full border-none outline-none rounded-6 text-very-dark-grayish-blue bg-very-light-gray dark:bg-very-dark-desaturated-blue dark:text-light-grayish-blue-dark caret-bright-blue' type="text" placeholder='Create a new todo...'/>
                </form>
            </div>
...
// className="rounded-6 w-full py-25 px-20 bg-very-light-gray dark:bg-very-dark-desaturated-blue caret-bright-blue shadow-md outline outline-1 outline-red-700"