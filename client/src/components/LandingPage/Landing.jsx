...
const Landing = () => {
  ...
  return (
    <div>
        <div className="bg-center bg-cover bg-no-repeat bg-mobile-light dark:bg-mobile-dark h-200 py-45 px-25 flex justify-between lg:bg-desktop-light lg:dark:bg-desktop-dark md:px-140 lg:px-300 xl:px-465 lg:h-300 lg:py-70">
        ...
        <div className="px-25 flex justify-center md:px-140 lg:px-300 xl:px-465">
